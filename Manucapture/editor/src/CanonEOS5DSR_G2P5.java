...
public class CanonEOS5DSR_G2P5 extends G2P5{

	public CanonEOS5DSR_G2P5() {
		super();
	}

	public CanonEOS5DSR_G2P5(String homeDirectory, String eosSerial, String port, String id) {
	...
	public static G2P5 create(String homeDirectory, String eosSerial, String id) {
		...
		G2P5 camera = new CanonEOS5DSR_G2P5(homeDirectory, eosSerial, port, id);
		return camera;
	}
