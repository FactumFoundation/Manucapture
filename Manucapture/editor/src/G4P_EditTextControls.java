...
public class G4P_EditTextControls extends PApplet {

	/*
	 * This sketch is to demonstrate some features of the GPassword, GTextField
	 * and GTextArea controls.
	 * 
	 * These features include - Tabbing between controls - Hidden text in
	 * password control between controls - Default text - Copy and paste text
	 * 
	...
	public void setup() {
		...
		// Some start text
		String[] paragraphs = { "lorem ipsum bla blab alksdjflksdajskadf", "adios hola" };
	...
	public void displayEvent(String name, GEvent event) {
		String extra = " event fired at " + millis() / 1000.0f + "s";
		print(name + "   ");
		switch (event) {
		case CHANGED:
	...
	static public void main(String[] passedArgs) {
		String[] appletArgs = new String[] { "G4P_EditTextControls" };
		if (passedArgs != null) {
