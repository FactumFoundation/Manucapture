...
class Camera(object):
    ...
    def trigger_capture(self, context):
        """
    ...
    def folder_put_file(self, folder, filename, type, file, context):
        """
    ...
    def file_read(self, folder, file, type, offset, buf, context):
        """
...
def gp_camera_autodetect(context):
    """
...
def gp_camera_trigger_capture(camera, context):
    """
...
def gp_camera_folder_put_file(camera, folder, filename, type, file, context):
    """
...
def gp_camera_file_read(camera, folder, file, type, offset, buf, context):
    """
