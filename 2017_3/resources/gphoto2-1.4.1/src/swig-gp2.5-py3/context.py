...
class Context(object):
    ...
    def camera_autodetect(self) -> "void":
        """
...
def gp_context_set_idle_func(context: 'Context', func: 'GPContextIdleFunc', data: 'void *') -> "void":
    """
...
def gp_context_set_progress_funcs(context: 'Context', start_func: 'GPContextProgressStartFunc', update_func: 'GPContextProgressUpdateFunc', stop_func: 'GPContextProgressStopFunc', data: 'void *') -> "void":
    """
...
def gp_context_set_error_func(context: 'Context', func: 'GPContextErrorFunc', data: 'void *') -> "void":
    """
...
def gp_context_set_status_func(context: 'Context', func: 'GPContextStatusFunc', data: 'void *') -> "void":
    """
...
def gp_context_set_question_func(context: 'Context', func: 'GPContextQuestionFunc', data: 'void *') -> "void":
    """
...
def gp_context_set_cancel_func(context: 'Context', func: 'GPContextCancelFunc', data: 'void *') -> "void":
    """
...
def gp_context_set_message_func(context: 'Context', func: 'GPContextMessageFunc', data: 'void *') -> "void":
    """
...
def gp_context_idle(context: 'Context') -> "void":
    """
...
def gp_context_error(context: 'Context', format: 'char const *') -> "void":
    """
...
def gp_context_status(context: 'Context', format: 'char const *') -> "void":
    """
...
def gp_context_message(context: 'Context', format: 'char const *') -> "void":
    """
...
def gp_context_question(context: 'Context', format: 'char const *') -> "GPContextFeedback":
    """
...
def gp_context_cancel(context: 'Context') -> "GPContextFeedback":
    """
...
def gp_context_progress_start(context: 'Context', target: 'float', format: 'char const *') -> "unsigned int":
    """
...
def gp_context_progress_update(context: 'Context', id: 'unsigned int', current: 'float') -> "void":
    """
...
def gp_context_progress_stop(context: 'Context', id: 'unsigned int') -> "void":
    """
