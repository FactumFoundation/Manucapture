...
def gp_filesystem_set_info_noop(fs: '_CameraFilesystem', folder: 'char const *', filename: 'char const *', info: 'CameraFileInfo', context: 'Context') -> "int":
    """
...
def gp_filesystem_set_file_noop(fs: '_CameraFilesystem', folder: 'char const *', filename: 'char const *', type: 'CameraFileType', file: 'CameraFile', context: 'Context') -> "int":
    """
...
def gp_filesystem_read_file(fs: '_CameraFilesystem', folder: 'char const *', filename: 'char const *', type: 'CameraFileType', offset: 'uint64_t', buf: 'char *', size: 'uint64_t *', context: 'Context') -> "int":
    """
...
def gp_filesystem_put_file(fs: '_CameraFilesystem', folder: 'char const *', filename: 'char const *', type: 'CameraFileType', file: 'CameraFile', context: 'Context') -> "int":
    """
