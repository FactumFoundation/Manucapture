...
#define SWIGTYPE_p_GPVersionVerbosity swig_types[0]
...
extern "C" {
#endif
SWIGINTERN PyObject *GP_VERSION_SHORT_swigconstant(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *module;
  PyObject *d;
  if (!SWIG_Python_UnpackTuple(args,(char*)"swigconstant", 1, 1,&module)) return NULL;
  d = PyModule_GetDict(module);
  if (!d) return NULL;
  SWIG_Python_SetConstant(d, "GP_VERSION_SHORT",SWIG_From_int((int)(GP_VERSION_SHORT)));
  return SWIG_Py_Void();
}


SWIGINTERN PyObject *GP_VERSION_VERBOSE_swigconstant(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *module;
  PyObject *d;
  if (!SWIG_Python_UnpackTuple(args,(char*)"swigconstant", 1, 1,&module)) return NULL;
  d = PyModule_GetDict(module);
  if (!d) return NULL;
  SWIG_Python_SetConstant(d, "GP_VERSION_VERBOSE",SWIG_From_int((int)(GP_VERSION_VERBOSE)));
  return SWIG_Py_Void();
}


SWIGINTERN PyObject *_wrap_gp_port_library_version(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
...
SWIGINTERN PyObject *_wrap_gp_library_version(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  GPVersionVerbosity arg1 ;
  int val1 ;
  int ecode1 = 0 ;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"GP_VERSION_SHORT_swigconstant", GP_VERSION_SHORT_swigconstant, METH_VARARGS, NULL},
	 { (char *)"GP_VERSION_VERBOSE_swigconstant", GP_VERSION_VERBOSE_swigconstant, METH_VARARGS, NULL},
	 { (char *)"gp_port_library_version", (PyCFunction)_wrap_gp_port_library_version, METH_O, (char *)"\n"
		"gp_port_library_version(verbose) -> char const **\n"
		"\n"
		"Parameters:\n"
		"    verbose: enum GPVersionVerbosity\n"
		"\n"
		""},
	 { (char *)"gp_library_version", (PyCFunction)_wrap_gp_library_version, METH_O, (char *)"\n"
