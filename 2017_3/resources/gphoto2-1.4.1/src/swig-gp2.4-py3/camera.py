...
class Camera(object):
    ...
    def folder_put_file(self, folder: 'char const *', file: 'CameraFile', context: 'Context') -> "void":
        """
...
def gp_camera_folder_put_file(camera: 'Camera', folder: 'char const *', file: 'CameraFile', context: 'Context') -> "int":
    """
