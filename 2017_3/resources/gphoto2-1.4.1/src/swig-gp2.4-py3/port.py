...
class GPPortSettingsDisk(object):
    """Proxy of C _GPPortSettingsDisk struct"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    mountpoint = _swig_property(_port.GPPortSettingsDisk_mountpoint_get, _port.GPPortSettingsDisk_mountpoint_set)
    __swig_destroy__ = _port.delete_GPPortSettingsDisk
GPPortSettingsDisk_swigregister = _port.GPPortSettingsDisk_swigregister
GPPortSettingsDisk_swigregister(GPPortSettingsDisk)
...
def gp_port_set_info(port: 'GPPort', info: '_GPPortInfo') -> "int":
    """
...
def gp_port_get_info(port: 'GPPort') -> "GPPortInfo *":
    """
...
def gp_port_open(port: 'GPPort') -> "int":
    """
...
def gp_port_close(port: 'GPPort') -> "int":
    """
...
def gp_port_write(port: 'GPPort', data: 'char const *', size: 'int') -> "int":
    """
...
def gp_port_read(port: 'GPPort', data: 'char *', size: 'int') -> "int":
    """
...
def gp_port_check_int(port: 'GPPort', data: 'char *', size: 'int') -> "int":
    """
...
def gp_port_check_int_fast(port: 'GPPort', data: 'char *', size: 'int') -> "int":
    """
...
def gp_port_get_timeout(port: 'GPPort', timeout: 'int *') -> "int":
    """
...
def gp_port_set_timeout(port: 'GPPort', timeout: 'int') -> "int":
    """
...
def gp_port_set_settings(port: 'GPPort', settings: 'GPPortSettings') -> "int":
    """
...
def gp_port_get_settings(port: 'GPPort', settings: 'GPPortSettings *') -> "int":
    """
...
def gp_port_get_pin(port: 'GPPort', pin: 'GPPin', level: 'GPLevel *') -> "int":
    """
...
def gp_port_set_pin(port: 'GPPort', pin: 'GPPin', level: 'GPLevel') -> "int":
    """
...
def gp_port_send_break(port: 'GPPort', duration: 'int') -> "int":
    """
...
def gp_port_flush(port: 'GPPort', direction: 'int') -> "int":
    """
...
def gp_port_usb_find_device(port: 'GPPort', idvendor: 'int', idproduct: 'int') -> "int":
    """
...
def gp_port_usb_find_device_by_class(port: 'GPPort', mainclass: 'int', subclass: 'int', protocol: 'int') -> "int":
    """
...
def gp_port_usb_clear_halt(port: 'GPPort', ep: 'int') -> "int":
    """
...
def gp_port_usb_msg_write(port: 'GPPort', request: 'int', value: 'int', index: 'int', bytes: 'char *', size: 'int') -> "int":
    """
...
def gp_port_usb_msg_read(port: 'GPPort', request: 'int', value: 'int', index: 'int', bytes: 'char *', size: 'int') -> "int":
    """
...
def gp_port_usb_msg_interface_write(port: 'GPPort', request: 'int', value: 'int', index: 'int', bytes: 'char *', size: 'int') -> "int":
    """
...
def gp_port_usb_msg_interface_read(port: 'GPPort', request: 'int', value: 'int', index: 'int', bytes: 'char *', size: 'int') -> "int":
    """
...
def gp_port_usb_msg_class_write(port: 'GPPort', request: 'int', value: 'int', index: 'int', bytes: 'char *', size: 'int') -> "int":
    """
...
def gp_port_usb_msg_class_read(port: 'GPPort', request: 'int', value: 'int', index: 'int', bytes: 'char *', size: 'int') -> "int":
    """
...
def gp_port_seek(port: 'GPPort', offset: 'int', whence: 'int') -> "int":
    """
...
def gp_port_send_scsi_cmd(port: 'GPPort', to_dev: 'int', cmd: 'char *', cmd_size: 'int', sense: 'char *', sense_size: 'int', data: 'char *', data_size: 'int') -> "int":
    """
...
def gp_port_set_error(port: 'GPPort', format: 'char const *') -> "int":
    """
...
def gp_port_get_error(port: 'GPPort') -> "char const *":
    """
