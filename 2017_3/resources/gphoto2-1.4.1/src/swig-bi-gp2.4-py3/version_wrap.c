...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_gp_port_library_version(PyObject *self, PyObject *args) {
...
SWIGINTERN PyObject *_wrap_gp_library_version(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GPVersionVerbosity arg1 ;
  int val1 ;
  int ecode1 = 0 ;
...
# endif
  ...
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_VERSION_SHORT",SWIG_From_int((int)(GP_VERSION_SHORT)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_VERSION_VERBOSE",SWIG_From_int((int)(GP_VERSION_VERBOSE)));
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
