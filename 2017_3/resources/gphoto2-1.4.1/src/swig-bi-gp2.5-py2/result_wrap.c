...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_gp_port_result_as_string(PyObject *self, PyObject *args) {
...
SWIGINTERN PyObject *_wrap_gp_result_as_string(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
...
# endif
  ...
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_BAD_PARAMETERS",SWIG_From_int((int)(-2)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_NO_MEMORY",SWIG_From_int((int)(-3)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_LIBRARY",SWIG_From_int((int)(-4)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_UNKNOWN_PORT",SWIG_From_int((int)(-5)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_NOT_SUPPORTED",SWIG_From_int((int)(-6)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_IO",SWIG_From_int((int)(-7)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_FIXED_LIMIT_EXCEEDED",SWIG_From_int((int)(-8)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_TIMEOUT",SWIG_From_int((int)(-10)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_IO_SUPPORTED_SERIAL",SWIG_From_int((int)(-20)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_IO_SUPPORTED_USB",SWIG_From_int((int)(-21)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_IO_INIT",SWIG_From_int((int)(-31)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_IO_READ",SWIG_From_int((int)(-34)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_IO_WRITE",SWIG_From_int((int)(-35)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_IO_UPDATE",SWIG_From_int((int)(-37)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_IO_SERIAL_SPEED",SWIG_From_int((int)(-41)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_IO_USB_CLEAR_HALT",SWIG_From_int((int)(-51)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_IO_USB_FIND",SWIG_From_int((int)(-52)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_IO_USB_CLAIM",SWIG_From_int((int)(-53)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_IO_LOCK",SWIG_From_int((int)(-60)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_HAL",SWIG_From_int((int)(-70)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_CORRUPTED_DATA",SWIG_From_int((int)(-102)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_FILE_EXISTS",SWIG_From_int((int)(-103)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_MODEL_NOT_FOUND",SWIG_From_int((int)(-105)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_DIRECTORY_NOT_FOUND",SWIG_From_int((int)(-107)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_FILE_NOT_FOUND",SWIG_From_int((int)(-108)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_DIRECTORY_EXISTS",SWIG_From_int((int)(-109)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_CAMERA_BUSY",SWIG_From_int((int)(-110)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_PATH_NOT_ABSOLUTE",SWIG_From_int((int)(-111)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_CANCEL",SWIG_From_int((int)(-112)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_CAMERA_ERROR",SWIG_From_int((int)(-113)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_OS_FAILURE",SWIG_From_int((int)(-114)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_ERROR_NO_SPACE",SWIG_From_int((int)(-115)));
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
